...
Install virtualization guest addons based on `ansible_facts.virtualization_type`. This is meant to be extended when the need arises. Currently it supports the following virtualization environments:
* kvm
